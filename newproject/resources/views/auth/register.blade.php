                                ...
                                <div class="card-body">
                                    ...
                                    @csrf
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <input type="name" value="{{ old('name') }}" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Full Name" required>
                                            @error('name')
                                        ...
                                        <div class="mb-6 mt-4">
                                            ...
                                            <input type="username" value="{{ old('username') }}" name="username" id="username" class="form-control @error('username') is-invalid @enderror" placeholder="Enter Username" required>
                                            @error('username')
